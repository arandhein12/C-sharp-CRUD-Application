...
namespace Open.Tests.Aids {
    ...
    [TestClass] public class GetRandomTests : BaseTests {
        ...
        private static void doTests<T>(Func<T, T, T> funct, T min, T max)
            where T : IComparable {
            var l = new List<T>();
            for (var i = 0; i < 10; i++) {
                T r;
        ...
        [TestMethod] public void Int16Test() {
            ...
            doGetRandomTests(GetRandom.Int16, (short) -2000, (short) 100);
            ...
            doGetRandomTests(GetRandom.Int16, (short) (sbyte.MaxValue - 100), short.MaxValue);
